...
enum MockDataService {
    static let popularFilms: [Film] = [
        ...
        Film(id: "2", title: "The Godfather", year: "1972", genre: ["Crime", "Drama"], director: "Francis Ford Coppola", cast: ["Marlon Brando", "Al Pacino"], synopsis: "The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant youngest son.", posterURL: "https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsRolD1fZdja1.jpg", runtime: "2h 55m"),
        ...
        Film(id: "4", title: "Pulp Fiction", year: "1994", genre: ["Crime", "Drama"], director: "Quentin Tarantino", cast: ["John Travolta", "Uma Thurman", "Samuel L. Jackson"], synopsis: "The lives of two mob hitmen, a boxer, a gangster and his wife, and a pair of diner bandits intertwine in four tales of violence and redemption.", posterURL: "https://image.tmdb.org/t/p/w500/d5iIlFn5s0ImszYzBPb8JPIfbXD.jpg", runtime: "2h 34m"),
        ...
        Film(id: "12", title: "Oppenheimer", year: "2023", genre: ["Biography", "Drama", "History"], director: "Christopher Nolan", cast: ["Cillian Murphy", "Emily Blunt", "Robert Downey Jr."], synopsis: "The story of American scientist J. Robert Oppenheimer and his role in the development of the atomic bomb.", posterURL: "https://image.tmdb.org/t/p/w500/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg", runtime: "3h"),
        Film(id: "13", title: "Dune: Part Two", year: "2024", genre: ["Action", "Adventure", "Drama"], director: "Denis Villeneuve", cast: ["Timothée Chalamet", "Zendaya"], synopsis: "Paul Atreides unites with Chani and the Fremen while on a warpath of revenge against the conspirators who destroyed his family.", posterURL: "https://image.tmdb.org/t/p/w500/8b8R8l88Qje9dn9OE8PY05Nez7.jpg", runtime: "2h 46m"),
        ...
        Film(id: "15", title: "The Brutalist", year: "2025", genre: ["Drama"], director: "Brady Corbet", cast: ["Adrien Brody", "Felicity Jones"], synopsis: "A visionary architect escapes post-war Europe and arrives in America to rebuild his life.", posterURL: "https://image.tmdb.org/t/p/w500/zp5AEZmGOsCtelKeFmRtiPaWbPP.jpg", runtime: "3h 35m"),
    ]
    ...
    static let tvShows: [Film] = [
        ...
        Film(id: "tv2", title: "The Bear", year: "2022", genre: ["Comedy", "Drama"], director: "Christopher Storer", cast: ["Jeremy Allen White", "Ayo Edebiri"], synopsis: "A young chef from the fine dining world returns to Chicago to run his family's sandwich shop.", posterURL: "https://image.tmdb.org/t/p/w500/sHFlZTDMrL85mAJHqIbMj9HnKgo.jpg", runtime: "30m", isTV: true),
        Film(id: "tv3", title: "Severance", year: "2022", genre: ["Drama", "Mystery", "Sci-Fi"], director: "Dan Erickson", cast: ["Adam Scott", "Britt Lower"], synopsis: "Mark leads a team of office workers whose memories have been surgically divided between their work and personal lives.", posterURL: "https://image.tmdb.org/t/p/w500/lFf6LLrQjYZEMBsGCsbWMPHBxGo.jpg", runtime: "55m", isTV: true),
    ]
