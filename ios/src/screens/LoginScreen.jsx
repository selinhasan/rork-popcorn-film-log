...
export default function LoginScreen() {
  ...
  async function handleLogin() {
    ...
    // No manual navigation here -- once login() succeeds, `user` is set
    // in AuthContext and your root navigator switches to the main app
    // automatically (see navigation/RootNavigator.example.jsx).
  }
